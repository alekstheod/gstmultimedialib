...
swstring::swstring(void) : lexical<wstring>() {
}

swstring::swstring(const swstring& str) : lexical<wstring>(str._value) {
    _value = str._value;
}

swstring::swstring(const wchar_t* str) : lexical<wstring>(wstring(str)) {
    _value = str;
}
